    ...
    <MainLayout hideSidebar={!isMobile}>
      <div className="flex flex-col h-full">
        <div className="p-4 border-b border-[#2a2a2a] flex items-center">
          ...
          <h1 className="text-lg font-medium text-white ml-2">Create New Bot</h1>
        </div>

        <div className="flex-1 overflow-auto p-4">
          <div className="max-w-3xl mx-auto">
            <div className="mb-6 text-center md:text-left">
              <h2 className="text-2xl font-bold text-white mb-2">Creating a bot is easier than you think</h2>
              <p className="text-gray-400">Follow these simple steps to create your Telegram bot</p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-medium text-white">Send the /newbot command</h3>
                  </div>
                  <div className="ml-8">
                    <div className="flex items-center gap-2">
                      <code className="bg-[#121212] px-2 py-1 rounded text-sm">/newbot</code>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-medium text-white">Follow the instructions and get your token</h3>
                  </div>
                  <div className="ml-8">
                    <p className="text-gray-400 text-sm">
                      BotFather will ask for a name and username for your bot. After that, you'll receive an API token.
                    </p>
                  </div>
                </div>
