    ...
    <MainLayout hideSidebar={!isMobile}>
      <div className="flex flex-col h-full">
        <div className="p-4 border-b border-[#2a2a2a] flex items-center">
          ...
          <h1 className="text-lg font-medium text-white ml-2">Connect Channel</h1>
        </div>

        <div className="flex-1 p-4 overflow-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* Instagram */}
            <div className="bg-[#121212] rounded-lg border border-[#2a2a2a] p-4 flex flex-col items-center">
